				...
				<div class="container">
					...
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							...
							<p>The Royal Bengal Tiger, India's national animal, is a majestic symbol of strength and grace, known for its striking orange coat with black stripes.</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>South China Tiger</h4>
							<p>Functionally extinct in the wild, this species has a vibrant orange coat with distinctive wide-spaced stripes, representing a tragic story of conservation.</p>
						</div>
